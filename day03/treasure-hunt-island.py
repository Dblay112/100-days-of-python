...
if crossroad == "left":
        swim_choice = input('You\'ve come to a lake. There is an island in the middle of the lake Type "wait" to wait
        for a boat or type "swim" to swim accross.').lower()
            if swim_choice == "wait":
                        door_choice = input('You arrive at the island unharmed. There is a house with 3 doors. One red,
                        one yellow and one blue. Which colour do you choose?').lower()
                                if door_choice == "yellow":
                                                print("You Win!!!")
                                                        elif door_choice == "red" or "blue":
                                                                        print("You entered a room of beast. Game
                                                                        Over!!!")
